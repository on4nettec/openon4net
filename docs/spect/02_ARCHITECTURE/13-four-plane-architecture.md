...
- Context orchestration و Prompt Builder (identity/task/memory/tools/permissions/language)
...
- Context package در Plane 1 ساخته می‌شود و با memory/identity/policy/skills به Prompt Builder تزریق می‌شود.
