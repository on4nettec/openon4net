...
| CP-057 | WhatsApp Channel Plugin (سمت Platform)                                                                                                                                                  | وابسته به CP-052 + CP-053. نیمه‌ی Platform جفت RT-141                                                                                                                                                       |
| CP-058 | Discord Channel Plugin (سمت Platform)                                                                                                                                                   | وابسته به CP-052 + CP-053. نیمه‌ی Platform جفت RT-142                                                                                                                                                       |
| CP-059 | Google Chat Channel Plugin (سمت Platform)                                                                                                                                               | وابسته به CP-052 + CP-053. نیمه‌ی Platform جفت RT-143                                                                                                                                                       |
| CP-060 | WeChat Channel Plugin (سمت Platform)                                                                                                                                                    | وابسته به CP-052 + CP-053. نیمه‌ی Platform جفت RT-144                                                                                                                                                       |
...
| CP-063 | Instagram DM Channel Plugin (سمت Platform) | وابسته به CP-052 + CP-053. همون Meta OAuth app بالا قابل‌استفاده‌ی مجدده. نیمه‌ی Platform جفت RT-147 |
| CP-064 | TikTok Connector Plugin (فقط سمت Platform، بدون جفت Runtime) | وابسته به CP-052. الگوی پلاگین Google، نه الگوی Channel. نیاز به OAuth app واقعی TikTok for Developers |
| CP-065 | LinkedIn Connector Plugin (فقط سمت Platform، بدون جفت Runtime) | ⚠️ API رسمی messaging محدود/partner-only — فاز اول فقط publish/read |
| CP-066 | YouTube Connector Plugin (فقط سمت Platform، بدون جفت Runtime) | ⚠️ اصلاً DM نداره — فقط آپلود ویدیو/مدیریت کامنت |
