...
| Runtime — کارهای بعد از Sprint 0  | ۲۲ فیچر تکمیل (RT-001..RT-004 + RT-006..RT-010 + RT-014..RT-018 + RT-024 + RT-026 + RT-029 + RT-032..RT-033)، همه تست‌شده به‌جز ارسال واقعی تلگرام و OAuth با یک app واقعی Google/GitHub؛ جزئیات RT-032/033 پایین‌تر (اولین تست‌های vitest واقعی در Runtime — قبلاً فقط curl/Playwright بود)                  |
...
- Plugin SDK، Plugin CLI، Marketplace Skills-listing (فروشی/رایگان)، activation-gated free tier (نیازمند T-CP-007: Runtime activation client) — عمداً موکول شد، جزئیات در `06_MEETINGS/02-skills-plugins-marketplace-model.md`.
