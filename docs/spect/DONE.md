...
| Runtime — کارهای بعد از Sprint 0  | ۱۸ فیچر تکمیل (RT-001..RT-004 + RT-006..RT-010 + RT-014..RT-018 + RT-029)، همه تست‌شده به‌جز ارسال واقعی تلگرام و OAuth با یک app واقعی Google/GitHub                                                                                                                                        |
