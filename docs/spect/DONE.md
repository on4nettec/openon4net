...
- هفته ۲۹-۳۲ فاز ۳ روی صفر: Digital Employee (role catalog ساختاریافته، ابزار hierarchy/org-chart، KPI engine واقعی، مفهوم «Agent → Employee») و کل Agent Teams (ارتباط agent-to-agent، workflow/DAG engine، team assignment، task delegation).
